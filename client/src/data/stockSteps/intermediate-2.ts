...
export const INTERMEDIATE_BANKS_2: ProcedureBank[] = [
  ...
  // ═════════════════════════════════════════════════════════════════════════
  {
    ...
    spec: {
      ...
      risks: ["thrombosis", "hemorrhage", "hypoxia", "nerve_injury"],
  ...
  // ═════════════════════════════════════════════════════════════════════════
  {
    ...
    spec: {
      ...
      risks: ["nerve_injury", "hemorrhage", "hypoxia"],
