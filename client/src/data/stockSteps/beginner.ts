...
export const BEGINNER_BANKS: ProcedureBank[] = [
  ...
  // ═════════════════════════════════════════════════════════════════════════
  {
    ...
    spec: {
      ...
      risks: ["infection", "hemorrhage", "hypoxia"],
    ...
    steps: [
      ...
      {
        kind: "access", title: "Decide on drainage", description: "When does this wound need a drain?",
        choices: [
  ...
  // ═════════════════════════════════════════════════════════════════════════
  {
    ...
    spec: {
      ...
      risks: ["hypoxia", "nerve_injury", "hemorrhage"],
  ...
  // ═════════════════════════════════════════════════════════════════════════
  {
    ...
    spec: {
      ...
      risks: ["nerve_injury", "infection", "hemorrhage"],
